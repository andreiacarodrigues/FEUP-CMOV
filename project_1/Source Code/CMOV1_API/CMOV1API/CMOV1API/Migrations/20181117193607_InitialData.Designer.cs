...
namespace CMOV1API.Migrations
{
    ...
    [Migration("20181117193607_InitialData")]
            ...
            modelBuilder.Entity("CMOV1API.Model.Performance", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 2, Date = new DateTime(2020, 12, 2, 20, 0, 0, 0, DateTimeKind.Unspecified), Name = "Andreia no gelo", Price = 40m },
                        new { Id = 3, Date = new DateTime(2020, 12, 3, 19, 0, 0, 0, DateTimeKind.Unspecified), Name = "Quebra-Nozes", Price = 10m },
                        new { Id = 4, Date = new DateTime(2020, 12, 7, 19, 0, 0, 0, DateTimeKind.Unspecified), Name = "Concerto para salvar os pinguins", Price = 10m },
                        new { Id = 5, Date = new DateTime(2020, 12, 9, 19, 0, 0, 0, DateTimeKind.Unspecified), Name = "Show de Ballet", Price = 10m }
                    );
                });
            ...
            modelBuilder.Entity("CMOV1API.Model.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 5, Name = "Water", Price = 1m },
                        new { Id = 6, Name = "Candy", Price = 1m }
                    );
                });
